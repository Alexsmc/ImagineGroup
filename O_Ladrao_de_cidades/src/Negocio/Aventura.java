...
public class Aventura {
	...
	public static void main(String[] args) throws IOException{
		...
		System.out.println("Sua energia é de: " + heroi.getEnergia() + ". \nCuide bem da energia, se ela chegar a 0, é fim de aventura"
				+ " pra você he he he...");
		...
		System.out.println("Sua sorte é de: " + heroi.getSorte() + ". Você poderá fazer testes de sorte em vários momentos da aventura,\n"
